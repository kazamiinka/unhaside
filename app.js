...
app.get('/course/archieved/:courseId', passportConfig.isAuthenticated, courseController.archieved);
app.get('/course/publish/:courseId', passportConfig.isAuthenticated, courseController.publish);
